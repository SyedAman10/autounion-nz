...
function CheckInSystem() {
    ...
    const validateAndExtractLicense = (text)=>{
        ...
        // Check for common driving license keywords (must have at least 2)
        ...
        const keywordMatches = licenseKeywords.filter((keyword)=>normalizedText.includes(keyword)).length;
        if (keywordMatches < 2) {
            showNotification('❌ Invalid document! This does not appear to be a driving license.', 'error');
            return {
                valid: false,
                number: ''
            };
        ...
        for (const pattern of patterns){
            ...
            if (matches && matches.length > 0) {
                ...
                const filtered = matches.filter((m)=>!m.includes('CLASS') && !m.includes('CATEGORY') && m.length >= 8);
                if (filtered.length > 0) {
                    licenseNumber = filtered[0].replace(/\s/g, '');
                    break;
                }
            }
        }
        if (!licenseNumber) {
            showNotification('❌ Could not extract license number. Document may not be valid.', 'error');
            return {
                valid: false,
                number: ''
            };
        }
        showNotification('✅ Driving license validated! Number extracted: ' + licenseNumber, 'success');
        return {
            valid: true,
    ...
    const validateAndExtractPassport = (text)=>{
        const normalizedText = text.toUpperCase().replace(/\s+/g, ' ');
        // Check for common passport keywords (must have at least 2)
        ...
        const keywordMatches = passportKeywords.filter((keyword)=>normalizedText.includes(keyword)).length;
        if (keywordMatches < 2) {
            showNotification('❌ Invalid document! This does not appear to be a passport.', 'error');
            return {
                valid: false,
                number: ''
            };
        ...
        for (const pattern of patterns){
            ...
            if (matches && matches.length > 0) {
                ...
                const filtered = matches.filter((m)=>m.length >= 6 && m.length <= 10 && !m.includes('SEX'));
                if (filtered.length > 0) {
                    passportNumber = filtered[0].replace(/\s/g, '');
                    break;
                }
            }
        }
        if (!passportNumber) {
            showNotification('❌ Could not extract passport number. Document may not be valid.', 'error');
            return {
                valid: false,
                number: ''
            };
        }
        showNotification('✅ Passport validated! Number extracted: ' + passportNumber, 'success');
        return {
            valid: true,
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    checkIns.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: checkIns.map((checkIn)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                className: "pt-2 border-t border-gray-200 dark:border-gray-700 space-y-2",
                                                                children: [
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                        className: "bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-700 rounded p-2",
                                                                        children: [
                                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                                className: "flex items-center gap-2 text-xs text-blue-900 dark:text-blue-200",
                                                                                children: [
                                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("svg", {
                                                                            ...
                                                                            checkIn.licenseNumber && checkIn.licenseNumber !== 'N/A' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                                className: "ml-6 text-xs font-mono text-blue-800 dark:text-blue-300",
                                                                                children: [
                                                                                    "# ",
                                                                                    checkIn.licenseNumber
                                                                                ]
                                                                            }, void 0, true, {
                                                                                fileName: "[project]/src/app/page.js",
                                                                                lineNumber: 715,
                                                                    ...
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                        className: "bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-700 rounded p-2",
                                                                        children: [
                                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                            ...
                                                                            checkIn.passportNumber && checkIn.passportNumber !== 'N/A' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                                className: "ml-6 text-xs font-mono text-purple-800 dark:text-purple-300",
                                                                                children: [
                                                                                    "# ",
                                                                                    checkIn.passportNumber
                                                                                ]
                                                                            }, void 0, true, {
                                                                                fileName: "[project]/src/app/page.js",
                                                                                lineNumber: 728,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1fe1bb9a._.js.map